...
terminal 1:fgfs --fdm=null --native-fdm=socket,in,60,,5550,udp --aircraft=f16-block-52 --airport=ESSA --multiplay=out,10,127.0.0.1,5000 --multiplay=in,10,127.0.0.1,5001chou
...
terminal 3: python mainBVRGym.py -track t1 -seed 1 -v
...
### BVR air combat MultiAgent

python mainBVRGym.py -track dogv2

python mainBVRGym_MultiCore.py -track Dogv2 -cpus 10 -Eps 10000 -eps 1
