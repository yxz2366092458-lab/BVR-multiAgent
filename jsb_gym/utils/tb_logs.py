...
class Dog_logsV2():
    def __init__(self, conf, name='/DOGV2', reset_logs=True):
        self.log_dir = conf.logs['log_path'] + name
        if reset_logs:
            self.clear_flightdata()
    ...
    def record(self, env):
        ...
        sim_time_f16_1 = env.f16_1.get_sim_time_sec()
        sim_time_f16_2 = env.f16_1.get_sim_time_sec()

        sim_time_f16r_1 = env.f16r_1.get_sim_time_sec()
        sim_time_f16r_2 = env.f16r_1.get_sim_time_sec()


        # location
        self.writer.add_scalar("f16_1_lat", env.f16_1.get_lat_gc_deg(), sim_time_f16_1)
        self.writer.add_scalar("f16_1_long", env.f16_1.get_long_gc_deg(), sim_time_f16_1)
        self.writer.add_scalar("f16_1_alt", env.f16_1.get_altitude(), sim_time_f16r_1)

        self.writer.add_scalar("f16_2_lat", env.f16_2.get_lat_gc_deg(), sim_time_f16_2)
        self.writer.add_scalar("f16_2_long", env.f16_2.get_long_gc_deg(), sim_time_f16_2)
        self.writer.add_scalar("f16_2_alt", env.f16_2.get_altitude(), sim_time_f16r_2)

        self.writer.add_scalar("f16r_1_lat", env.f16r_1.get_lat_gc_deg(), sim_time_f16r_1)
        self.writer.add_scalar("f16r_1_long", env.f16r_1.get_long_gc_deg(), sim_time_f16r_1)
        self.writer.add_scalar("f16r_1_alt", env.f16r_1.get_altitude(), sim_time_f16r_1)

        self.writer.add_scalar("f16r_2_lat", env.f16r_2.get_lat_gc_deg(), sim_time_f16r_2)
        self.writer.add_scalar("f16r_2_long", env.f16r_2.get_long_gc_deg(), sim_time_f16r_2)
        self.writer.add_scalar("f16r_2_alt", env.f16r_2.get_altitude(), sim_time_f16r_2)

        if env.aim_block_1['aim1_f16_1'].active:
            self.writer.add_scalar("aim1_f16_1_lat", env.aim_block_1['aim1_f16_1'].get_lat_gc_deg(),
                                   env.aim_block_1['aim1_f16_1'].get_sim_time_sec())
            self.writer.add_scalar("aim1_f16_1_long", env.aim_block_1['aim1_f16_1'].get_long_gc_deg(),
                                   env.aim_block_1['aim1_f16_1'].get_sim_time_sec())
            self.writer.add_scalar("aim1_f16_1_alt", env.aim_block_1['aim1_f16_1'].get_altitude(),
                                   env.aim_block_1['aim1_f16_1'].get_sim_time_sec())
        else:
            pass

        if env.aim_block_1['aim2_f16_1'].active:
            self.writer.add_scalar("aim2_f16_1_lat", env.aim_block_1['aim2_f16_1'].get_lat_gc_deg(),
                                   env.aim_block_1['aim2_f16_1'].get_sim_time_sec())
            self.writer.add_scalar("aim2_f16_1_long", env.aim_block_1['aim2_f16_1'].get_long_gc_deg(),
                                   env.aim_block_1['aim2_f16_1'].get_sim_time_sec())
            self.writer.add_scalar("aim2_f16_1_alt", env.aim_block_1['aim2_f16_1'].get_altitude(),
                                   env.aim_block_1['aim2_f16_1'].get_sim_time_sec())
        else:
            pass

        if env.aim_block_2['aim1_f16_2'].active:
            self.writer.add_scalar("aim1_f16_2_lat", env.aim_block_2['aim1_f16_2'].get_lat_gc_deg(),
                                   env.aim_block_2['aim1_f16_2'].get_sim_time_sec())
            self.writer.add_scalar("aim1_f16_2_long", env.aim_block_2['aim1_f16_2'].get_long_gc_deg(),
                                   env.aim_block_2['aim1_f16_2'].get_sim_time_sec())
            self.writer.add_scalar("aim1_f16_2_alt", env.aim_block_2['aim1_f16_2'].get_altitude(),
                                   env.aim_block_2['aim1_f16_2'].get_sim_time_sec())
        else:
            pass

        if env.aim_block_2['aim2_f16_2'].active:
            self.writer.add_scalar("aim2_f16_2_lat", env.aim_block_2['aim2_f16_2'].get_lat_gc_deg(),
                                   env.aim_block_2['aim2_f16_2'].get_sim_time_sec())
            self.writer.add_scalar("aim2_f16_2_long", env.aim_block_2['aim2_f16_2'].get_long_gc_deg(),
                                   env.aim_block_2['aim2_f16_2'].get_sim_time_sec())
            self.writer.add_scalar("aim2_f16_2_alt", env.aim_block_2['aim2_f16_2'].get_altitude(),
                                   env.aim_block_2['aim2_f16_2'].get_sim_time_sec())
        else:
            pass

        if env.aimr_block_1['aim1_f16r_1'].active:
            self.writer.add_scalar("aim1_f16r_1_lat", env.aimr_block_1['aim1_f16r_1'].get_lat_gc_deg(),
                                   env.aimr_block_1['aim1_f16r_1'].get_sim_time_sec())
            self.writer.add_scalar("aim1_f16r_1_long", env.aimr_block_1['aim1_f16r_1'].get_long_gc_deg(),
                                   env.aimr_block_1['aim1_f16r_1'].get_sim_time_sec())
            self.writer.add_scalar("aim1_f16r_1_alt", env.aimr_block_1['aim1_f16r_1'].get_altitude(),
                                   env.aimr_block_1['aim1_f16r_1'].get_sim_time_sec())
        else:
            pass

        if env.aimr_block_1['aim2_f16r_1'].active:
            self.writer.add_scalar("aim2_f16r_1_lat", env.aimr_block_1['aim2_f16r_1'].get_lat_gc_deg(),
                                   env.aimr_block_1['aim2_f16r_1'].get_sim_time_sec())
            self.writer.add_scalar("aim2_f16r_1_long", env.aimr_block_1['aim2_f16r_1'].get_long_gc_deg(),
                                   env.aimr_block_1['aim2_f16r_1'].get_sim_time_sec())
            self.writer.add_scalar("aim2_f16r_1_alt", env.aimr_block_1['aim2_f16r_1'].get_altitude(),
                                   env.aimr_block_1['aim2_f16r_1'].get_sim_time_sec())
        else:
            pass

        if env.aimr_block_2['aim1_f16r_2'].active:
            self.writer.add_scalar("aim1_f16r_2_lat", env.aimr_block_2['aim1_f16r_2'].get_lat_gc_deg(),
                                   env.aimr_block_2['aim1_f16r_2'].get_sim_time_sec())
            self.writer.add_scalar("aim1_f16r_2_long", env.aimr_block_2['aim1_f16r_2'].get_long_gc_deg(),
                                   env.aimr_block_2['aim1_f16r_2'].get_sim_time_sec())
            self.writer.add_scalar("aim1_f16r_2_alt", env.aimr_block_2['aim1_f16r_2'].get_altitude(),
                                   env.aimr_block_2['aim1_f16r_2'].get_sim_time_sec())
        else:
            pass

        if env.aimr_block_2['aim2_f16r_2'].active:
            self.writer.add_scalar("aim2_f16r_2_lat", env.aimr_block_2['aim2_f16r_2'].get_lat_gc_deg(),
                                   env.aimr_block_2['aim2_f16r_2'].get_sim_time_sec())
            self.writer.add_scalar("aim2_f16r_2_long", env.aimr_block_2['aim2_f16r_2'].get_long_gc_deg(),
                                   env.aimr_block_2['aim2_f16r_2'].get_sim_time_sec())
            self.writer.add_scalar("aim2_f16r_2_alt", env.aimr_block_2['aim2_f16r_2'].get_altitude(),
                                   env.aimr_block_2['aim2_f16r_2'].get_sim_time_sec())
        else:
            pass
